...
load('../../data/processed/state_action_features_raw.mat', 'state_action_features_raw');
...
%save the features
save('../../data/processed/state_action_features_std.mat', 'state_action_features_raw', 'state_action_features_std', 'std_feature', 'mean_feature');
fprintf(1,'Saved\n')
