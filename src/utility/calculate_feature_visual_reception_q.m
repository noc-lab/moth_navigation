...
x = Gridinfo(1,2) + (q_state(1) - 1/2)*Gridinfo(1,4);
y = Gridinfo(2,2) + (q_state(2) - 1/2)*Gridinfo(2,4);
if q_state(3) ==0
  heading = 0;
else
  heading = Gridinfo(3,2) + (q_state(3) - 1/2)*Gridinfo(3,4);
end

angular_res = Gridinfo(3,4);
